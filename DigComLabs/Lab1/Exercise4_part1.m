...
figure(1)
plot(x_time_domain, lp_time_domain_signal)
title("Downsampled By Factor of 12 Audio File Plot as a Function of Discrete Time (Fs=24kHz)"); 
xlabel('Time (sec)'); ylabel('Magnitude')
legend("Downsampled Audio File by Factor of 12 vs Discrete Time") ; grid on
%% Original Signal
