...
% x_gray_mapped = QPSK_gray_mapped(x)
% 
% code1 = x_gray_mapped(1)
% code2 = x_gray_mapped(2)
% bit1 = extract(code1,1)
% bit2 = extract(code2,2)
...
% lgd = legend;
% lgd.NumColumns = 2;
% xlabel("SNR (Es/No = 10^-^1^:^0^.^1^:^1)"); ylabel("Simulated Error Probability")
% title("Plot of Empirical and Theoretical 4QPSK Error Probability vs SNR")